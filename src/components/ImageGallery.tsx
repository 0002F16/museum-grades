...
export function ImageGallery({
  ...
  return (
    <div className="w-full">
      {/* Main Image */}
      <div className="relative aspect-square w-full" style={{ backgroundColor: "rgb(245,245,245)" }}>
        ...
        <button
          className={cn(
            ...
            "flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-md",
            "transition-opacity hover:opacity-80"
          )}
          aria-label="Add to wishlist"
        >
          <Heart className="h-5 w-5" style={{ color: "rgb(25,28,31)" }} />
          {wishlistCount > 0 && (
            <span
